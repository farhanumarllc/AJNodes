...
class Acf_Field_Block_Title extends \acf_field {
	...
	public function __construct() {
		 ...
		 */
		$this->label = __( 'Block Title', 'AJNodes_td' );
	...
	public function load_field( $field ) {
		...
		$sub_fields = array(
			...
			array(
				...
				'wrapper'           => array(
					'width' => '30',
					'class' => ( isset( $field['instructions_title'] ) && $field['instructions_title'] ) ? 'is-padding' : '',
					'id'    => '',
				),
				'default_value'     => '',
			),
	...
	public function render_field_settings( $field ) {
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions (Block Title)', 'AJNodes_td' ),
				'instructions' => __( 'Customize the Block Title input instructions', 'AJNodes_td' ),
				'type'         => 'text',
		...
		acf_render_field_setting(
			$field,
			array(
				'label'        => __( 'Instructions ( HTML Tag)', 'AJNodes_td' ),
				'instructions' => __( 'Customize the HTML tag input instructions', 'AJNodes_td' ),
				'type'         => 'text',
