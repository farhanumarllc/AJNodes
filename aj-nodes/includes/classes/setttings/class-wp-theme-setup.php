...
class WP_Theme_Setup {
	...
	public function setup_function() {
		...
		load_theme_textdomain( 'AJNodes_td' );
		...
		register_nav_menus(
			array(
				'header-nav'       => __( 'Header Nav', 'AJNodes_td' ),
				'footer-nav'   => __( 'Footer Nav', 'AJNodes_td' ),
				'legal-nav'        => __( 'Legal Nav', 'AJNodes_td' ),
			)
		);
