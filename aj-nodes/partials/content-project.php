...
$ajn_var_projects_title = $ajn_post_fields['ajn_var_projects_title'] ?? get_the_title( $ajn_var_post_id );
$ajn_var_project_text   = $ajn_post_fields['ajn_var_project_text'] ?? get_the_excerpt( $ajn_var_post_id );
	...
	<div class="wrapper">
		<div class="hero-dev-inner d-flex align-items-center justify-content-between">
			<div class="hero-dev-text">
				<h1 class="heading-1"><?php echo html_entity_decode( $ajn_var_projects_title ); ?></h1>
				<?php if ( $ajn_var_project_text ) { ?>
				<div class="hero-text-inner">
					<?php echo html_entity_decode( $ajn_var_project_text ); ?>
				</div>
				<?php } ?>
			</div>
